    ...
    <AnimatedCard delay={300}>
      ...
      >
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-end justify-center gap-12 lg:gap-16 py-10">
          ...
          <div className="relative z-0 -mx-16 hidden w-[180px] lg:flex flex-col items-center justify-end pb-[0px]">
            <div className="relative h-[140px] w-full">
              {/* duto simples — tubo reto com visor central de diesel */}
              <div className="absolute inset-x-0 top-[30px] flex -translate-y-1/2 items-center">
                {/* tubo esquerdo */}
