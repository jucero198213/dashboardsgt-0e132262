...
export function UpdateButton({
  ...
  return (
    <div className="relative">
      ...
      {isFetching && (
        <div className="absolute bottom-0 left-0 right-0 h-[2px] overflow-hidden rounded-b-lg bg-cyan-950/50">
          <div 
            className="h-full bg-gradient-to-r from-cyan-400 to-cyan-300 transition-all duration-300 ease-out shadow-[0_0_8px_rgba(34,211,238,0.6)]"
