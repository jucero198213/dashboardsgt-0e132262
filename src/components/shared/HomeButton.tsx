    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className="group inline-flex h-9 items-center gap-1.5 rounded-xl border-2 border-amber-500/60 bg-gradient-to-r from-amber-500/15 via-amber-400/10 to-amber-500/15 px-2.5 sm:px-3.5 text-[12px] font-bold uppercase tracking-wide text-amber-200 transition-all hover:border-amber-400 hover:from-amber-500/25 hover:to-amber-400/20 hover:text-amber-100 hover:-translate-y-0.5 hover:shadow-[0_6px_20px_rgba(245,158,11,0.28)] data-[state=open]:border-amber-400 data-[state=open]:from-amber-500/25 data-[state=open]:to-amber-400/20 data-[state=open]:text-amber-100"
        >
