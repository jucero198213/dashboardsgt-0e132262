...
export function HomeButton() {
  return (
    <Link
      ...
      className="group inline-flex h-9 w-9 sm:h-8 sm:w-auto items-center justify-center sm:gap-1.5 rounded-lg sm:rounded-lg border-2 sm:px-3.5 text-[12px] font-bold uppercase tracking-wide transition-all border-amber-500/60 bg-gradient-to-r from-amber-500/15 to-amber-400/10 text-amber-200 hover:border-amber-400 hover:from-amber-500/25 hover:to-amber-400/20 hover:text-amber-100 hover:-translate-y-0.5 hover:shadow-[0_4px_16px_rgba(245,158,11,0.25)]"
    >
