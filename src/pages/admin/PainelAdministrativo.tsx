...
const ACTION_ICON: Record<string, { icon: React.ElementType; color: string; badge: string }> = {
  ...
  ticket_updated: { icon: Ticket, color: "text-amber-400", badge: "bg-amber-500/10 text-amber-400 border-amber-500/20" },
  ticket_deleted: { icon: Ticket, color: "text-red-400", badge: "bg-red-500/10 text-red-400 border-red-500/20" },
