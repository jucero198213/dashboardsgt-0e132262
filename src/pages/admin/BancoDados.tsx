  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2.5 sm:gap-3 sm:grid-cols-4">
        {[
          { label: "Tabelas", value: String(TABLES.length), sub: "schema", glow: "rgba(6,182,212,0.06)" },
          { label: "Tamanho total", value: "~600MB", sub: "uso estimado", glow: "rgba(139,92,246,0.06)" },
          { label: "Queries/min", value: String(qps), sub: "média", color: "text-emerald-400", glow: "rgba(16,185,129,0.06)" },
          { label: "Conexões ativas", value: "18/100", sub: "pool ativo", glow: "rgba(245,158,11,0.06)" },
        ].map((s, i) => (
      ...
      <div className="grid gap-4 xl:grid-cols-[280px_1fr]">
        {/* Lista de tabelas */}
        <AnimatedCard delay={240} className="rounded-[20px] border border-[var(--sgt-border-subtle)] sgt-bg-card">
          <div className="p-4 space-y-1.5" style={{ background: "radial-gradient(ellipse at top left, rgba(139,92,246,0.04), transparent 60%)" }}>
        ...
        <div className="space-y-4">
          ...
          {selected && (
            <AnimatedCard delay={0} className="rounded-[20px] border border-[var(--sgt-border-subtle)] sgt-bg-card">
              <div className="p-5" style={{ background: "radial-gradient(ellipse at top left, rgba(6,182,212,0.04), transparent 60%)" }}>
          ...
          <AnimatedCard delay={320} className="rounded-[20px] border border-[var(--sgt-border-subtle)] sgt-bg-card">
            <div className="p-5 space-y-3" style={{ background: "radial-gradient(ellipse at top left, rgba(245,158,11,0.04), transparent 60%)" }}>
