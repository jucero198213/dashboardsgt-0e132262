  ...
  return (
    <div className="min-h-screen bg-[#060912] text-white px-3 py-4 sm:px-4 sm:py-6 lg:px-8 lg:py-8">
      ...
      <div className="relative mx-auto max-w-[1400px] space-y-6 animate-[fadeSlideIn_0.5s_ease-out]">
        ...
        <div className="relative overflow-hidden rounded-[22px] border border-emerald-400/[0.12] bg-[linear-gradient(150deg,rgba(10,16,36,0.98)_0%,rgba(5,9,20,1)_100%)] shadow-[0_0_0_1px_rgba(255,255,255,0.03),0_20px_60px_rgba(0,0,0,0.5)]">
