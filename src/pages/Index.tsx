    ...
    >
      ...
      <div className="flex justify-end mb-4">
        <button
          ...
          className="group flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs text-white/70 backdrop-blur-sm transition-all hover:bg-white/10 hover:text-white"
        >
          <Presentation className="h-4 w-4 opacity-70 group-hover:opacity-100" />
