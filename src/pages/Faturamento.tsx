...
export default function Faturamento() {
  ...
  const { faturamento, faturamentoMensal, faturamentoMensalAnterior, isFetchingDw, isProcessed, dwFilter, setDwFilter, fetchFromDW, filiais, empresas, dwError } = useFinancialData();
