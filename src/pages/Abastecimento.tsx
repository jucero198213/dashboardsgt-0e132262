              ...
              {[
                ...
                return (
                  <AnimatedCard key={label} delay={delay}>
                    <div
                      className={`group relative overflow-hidden rounded-[14px] sm:rounded-[16px] border border-white/[0.07] p-3.5 min-h-[120px] transition-all duration-300 hover:-translate-y-[3px]`}
